...
namespace AkademiPlusCQRS.Controllers
{
    public class Default : Controller
    {
        ...
        public Default(GetProductQueryHandler getProductQueryHandler, GetProductByIDQueryHandler getProductByIDQueryHandler, CreateProductCommandHandler createProductCommandHandler)
        {
